...
export function RiskMeter({ score, level }: RiskMeterProps) {
    const colorMap = {
        Low: "text-neon-green border-neon-green shadow-neon-green",
        Medium: "text-yellow-400 border-yellow-400 shadow-yellow-400",
        High: "text-neon-red border-neon-red shadow-neon-red",
    };
    ...
    return (
        <div className="glass-panel p-6 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="text-center mt-2 relative z-10">
                ...
                >
                    <span className={cn("text-4xl font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]", colorMap[level].split(" ")[0])}>
                        {level}
                    </span>
